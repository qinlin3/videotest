...
public class SimpleGetObjectSample {
    ...
    private static String accessKeyId = "LTAI4FnkWaJPtvQH7pUqabwu";
    private static String accessKeySecret = "gPjjidzqHtdK4SwbFMPX0zfq8TmDZm";

    private static String bucketName = "himea";
    //E:/video/src/main/resources/videoes/1.mp4
    private static String key = "1024";
